...
var patch = function patch() {
  ...
  var dfs = function dfs(node) {
    ...
    diff.forEach(function (_ref5) {
      ...
      if (action === REPLACE) {
        var newNode = WebDom.render(modifier);
      ...
      if (action === PROPS) {
        Object.keys(modifier).forEach(function (prop) {
          if (prop === 'style') {
            forOwn(modifier[prop], function (key, ob) {
      ...
      if (action === INSERT) {
        actions.push(function () {
          return node.appendChild(WebDom.render(modifier));
        });
      }
    }); // 插入，删除不用遍历子节点
...
},{}]},{},["../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../patch.js"], null)
//# sourceMappingURL=/patch.36aea501.map